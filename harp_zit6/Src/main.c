...
int main(void)
{
  ...
  MX_TIM6_Init();
  /* USER CODE BEGIN 2 */
  // DAC_Test_RV_TypeDef rv = generate_escalator_wave(&htim6, &hdac, &hdma_dac1);
  // DAC_Test_RV_TypeDef rv = generate_triangle_wave(&htim6, &hdac);
  DAC_Test_RV_TypeDef rv = generate_sine_wave(&htim6, &hdac, &hdma_dac1);
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOC, SD_CS_Pin|GPIO_PIN_6|GPIO_PIN_7|GPIO_PIN_8
                          |LED_YELLOW_EXTRA_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : SD_CS_Pin PC6 PC7 PC8 */
  GPIO_InitStruct.Pin = SD_CS_Pin|GPIO_PIN_6|GPIO_PIN_7|GPIO_PIN_8;
  ...
  /*Configure GPIO pin : LED_YELLOW_EXTRA_Pin */
  GPIO_InitStruct.Pin = LED_YELLOW_EXTRA_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(LED_YELLOW_EXTRA_GPIO_Port, &GPIO_InitStruct);
